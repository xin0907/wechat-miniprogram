...
$gwx = function (path, global) {
	...
	function $gwh() {
		...
		x.prototype = {
			...
			rv: function (obj) {
				return this.hn(obj, true) === 'n'
					? obj
					: this.rv(obj.__value__);
			},
			hm: function (obj) {
				if (typeof obj == 'object') {
					var cnt = 0;
			...
			if (typeof op === 'object') {
				...
				switch (vop) {
					...
					case 12:
						...
						return should_pass_type_info && (_tb || _ta)
							? wh.nh(_r, 'f')
							: _r;
				}
			} else {
			...
			do {
				...
				for (var i = 0; i < dom.children.length; i++) {
					...
					if (ch.tag == 'virtual') {
						...
						for (
							var j = 0;
							ch.children && j < ch.children.length;
							j++
						) {
	...
	var m0 = function (e, s, r, gg) {
		var z = gz$gwx_1();
		cs.push('logs.wxml:view:2:2');
		var oB = _n('view');
		_rz(z, oB, 'class', 0, e, s, gg);
		var xC = _v();
		_(oB, xC);
		cs.push('logs.wxml:block:3:4');
		var oD = function (cF, fE, hG, gg) {
			cs.push('logs.wxml:block:3:4');
			cs.push('logs.wxml:text:4:6');
			var cI = _n('text');
